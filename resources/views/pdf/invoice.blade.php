...
<body>
        ...
        <div class="tm_invoice_in">
          <div class="tm_invoice_head tm_align_center tm_mb20">
            <div class="tm_invoice_left">
              <div class="tm_logo"><img src="{{asset('template1')}}/assets/img/logo.svg" alt="Logo"></div>
            </div>
  ...
  <script src="{{asset('template1')}}/assets/js/jspdf.min.js"></script>
  <script src="{{asset('template1')}}/assets/js/html2canvas.min.js"></script>
